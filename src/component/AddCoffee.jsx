...
const AddCoffee = () => {
    const handleSubmit =e=>{
        ...
        const addCoffee = {name,chef,supplier,taste,details,category,photo}
        console.log(addCoffee);
        fetch('https://coffee-server-teal-two.vercel.app/coffee', {
        method:'POST',
        headers:{
       ...
       <div className="px-10 mx-auto">
        ...
        <div className="max-w-screen-lg mx-auto px-24 py-7 my-10 bg-[#F4F3F0]">
            ...
            <label className="block md:w-1/2">
				...
				<input type="text" name="name" placeholder="enter your name" className="block w-full rounded-md shadow-sm p-3 focus:ring focus:ring-opacity-75 focus:dark:ring-violet-600 dark:bg-gray-100" />
			</label>
			<label className="block md:w-1/2">
				<span className="mb-1">chef</span>
				<input type="text" name="chef" placeholder="Enter coffee chef" className="block w-full rounded-md shadow-sm p-3 focus:ring focus:ring-opacity-75 focus:dark:ring-violet-600 dark:bg-gray-100" />
			</label>
            </div>
			<div className="md:flex gap-5" >
            <label className="block md:w-1/2">
				<span className="mb-1">supplier</span>
				<input name="supplier" type="text" placeholder="Enter coffee supplier" className="block w-full rounded-md shadow-sm p-3 focus:ring focus:ring-opacity-75 focus:dark:ring-violet-600 dark:bg-gray-100" />
			</label>
			<label className="block md:w-1/2">
				<span className="mb-1">taste</span>
				<input type="text" name="taste" placeholder="Enter coffee taste" className="block w-full rounded-md shadow-sm p-3 focus:ring focus:ring-opacity-75 focus:dark:ring-violet-600 dark:bg-gray-100" />
			</label>
            </div>
			<div className="md:flex gap-5" >
            <label className="block md:w-1/2">
				<span className="mb-1">category</span>
				<input type="text" name="category" placeholder="Enter coffee category" className="block w-full rounded-md shadow-sm p-3 focus:ring focus:ring-opacity-75 focus:dark:ring-violet-600 dark:bg-gray-100" />
			</label>
			<label className="block md:w-1/2">
				<span className="mb-1">details</span>
				<input type="text" name="details" placeholder="Enter coffee details" className="block w-full rounded-md shadow-sm p-3 focus:ring focus:ring-opacity-75 focus:dark:ring-violet-600 dark:bg-gray-100" />
			</label>
            </div>
            <label className="block ">
				<span className="mb-1">Photo</span>
				<input type="text" name="photo" placeholder="Enter photo URL" className="block w-full rounded-md shadow-sm p-3 focus:ring focus:ring-opacity-75 focus:dark:ring-violet-600 dark:bg-gray-100" />
			</label>
