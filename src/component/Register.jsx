...
const Register = () => {
  ...
  const handleSubmitRegister = (e) => {
    ...
    const user = { name, photoLnk,email,password}
    console.log(user);
    ...
    .then(result=>{
        ...
        const userDetails ={uid,email,lastSignIn,createdAt};
        fetch('https://coffee-server-teal-two.vercel.app/coffee/users',{
            method:'POST',
            headers:{
        ...
        .then(data => {
            ...
            if (data.acknowledged) {
                Swal.fire({
                    ...
                    icon: 'success',
                    confirmButtonText: ' succesfull user created'
                })
                e.target.reset()
            }
        })
